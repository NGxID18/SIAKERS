...
<body id="appBody" class="h-full text-slate-900 antialiased flex flex-col min-h-screen bg-slate-100/80">
    ...
    <div class="flex flex-1 pt-16 relative">
        <aside id="sidebarDrawer" class="fixed top-16 left-0 bottom-0 w-64 bg-emerald-950 text-white border-r border-emerald-900 z-30 transform -translate-x-full md:translate-x-0 shadow-lg">
